...
func visualize_border():
	...
	for i in range(-1,border_size+1):
		...
		grid_map.set_cell_item( Vector3i(i,border_size,-1),3)
		grid_map.set_cell_item( Vector3i(i,border_size,border_size),3)
		grid_map.set_cell_item( Vector3i(border_size,border_size,i),3)
		grid_map.set_cell_item( Vector3i(-1,border_size,i),3)
		
		grid_map.set_cell_item( Vector3i(-1,i,-1),3)
		grid_map.set_cell_item( Vector3i(-1,i,border_size),3)
		grid_map.set_cell_item( Vector3i(border_size,i,-1),3)
		grid_map.set_cell_item( Vector3i(border_size,i,border_size),3)
